...
public class CreateOwner 
{
	...
	private void initialize() {
		...
		lblSurname.setBounds(28, 51, 74, 14);
		frame.getContentPane().add(lblSurname);
		
		JLabel lblAddress = new JLabel("Address:");
		lblAddress.setBounds(29, 76, 73, 14);
		frame.getContentPane().add(lblAddress);
		
		JLabel lblPhoneNumber = new JLabel("Phone Number:");
		lblPhoneNumber.setBounds(10, 167, 92, 14);
		frame.getContentPane().add(lblPhoneNumber);
		
		JLabel lblCreateAnOwner = new JLabel("Create an Owner Account");
		lblCreateAnOwner.setBounds(153, -2, 134, 14);
		frame.getContentPane().add(lblCreateAnOwner);
		
		textField = new JTextField();
		textField.setBounds(183, 23, 198, 20);
		frame.getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(183, 48, 198, 20);
		frame.getContentPane().add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(183, 73, 198, 20);
		frame.getContentPane().add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(183, 102, 198, 20);
		frame.getContentPane().add(textField_3);
		textField_3.setColumns(10);
		
		textField_4 = new JTextField();
		textField_4.setBounds(183, 133, 198, 20);
		frame.getContentPane().add(textField_4);
		textField_4.setColumns(10);
		
		textField_5 = new JTextField();
		textField_5.setBounds(183, 164, 198, 20);
		...
		btnSaveDetails.setBounds(140, 208, 108, 23);
