...
public class ConnectToDatabase {
	...
	public static Connection dbConnector(){
		...
		public  static void writeData(String role, String firstName, String surName, String username, String password){
			...
			public  static void writeDataAnimal(String Breed, String Gender, String Name, String Type, int OwnerID)
			{
				try{
					
					PreparedStatement ps = (PreparedStatement) con.prepareStatement("INSERT INTO  dbuseraccount.animal(Breed, Gender, Name, Type, OwnerID) VALUES( '" + Breed + "','" + Gender + "','" + Name + "','" + Type + "','" + OwnerID + "')");
