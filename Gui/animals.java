	...
	private void initialize() {
		...
		btnSelect.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					try{
						String query = "select * from dbuseraccount.users";   //will need to change to animal table
		...
		JTextPane txtpnAnimals = new JTextPane();
		txtpnAnimals.setEditable(false);
		txtpnAnimals.setBackground(UIManager.getColor("Button.background"));
