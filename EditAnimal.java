...
public class EditAnimal {
	...
	private void initialize() {
		...
		frmEditAnimal.setBounds(100, 100, 555, 362);
		...
		frmEditAnimal.getContentPane().add(lblPleaseSelectThe);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(258, 37, 243, 236);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try{
					...
					String animalID =(table.getModel().getValueAt(row, 0)).toString();
					
					String query = "select * from dbuseraccount.animal  where aniID= '"+animalID+"'";
					PreparedStatement ps = (PreparedStatement) con.prepareStatement(query);
					ResultSet rs = ps.executeQuery();
					...
					while (rs.next()){
						...
						textField_5.setText(rs.getString("OwnerID"));
		...
		frmEditAnimal.getContentPane().add(lblName);
		...
		frmEditAnimal.getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new JTextField();
		textField_1.setBounds(89, 75, 122, 28);
		frmEditAnimal.getContentPane().add(textField_1);
		textField_1.setColumns(10);
		
		textField_2 = new JTextField();
		textField_2.setBounds(89, 113, 122, 28);
		frmEditAnimal.getContentPane().add(textField_2);
		textField_2.setColumns(10);
		
		textField_3 = new JTextField();
		textField_3.setBounds(89, 151, 122, 28);
		frmEditAnimal.getContentPane().add(textField_3);
		textField_3.setColumns(10);
		
		JLabel lblOwnerId = new JLabel("Owner ID:");
		lblOwnerId.setBounds(6, 206, 55, 16);
		frmEditAnimal.getContentPane().add(lblOwnerId);
		
		textField_5 = new JTextField();
		textField_5.setBounds(89, 200, 122, 28);
		frmEditAnimal.getContentPane().add(textField_5);
		...
		btnEdit.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				if(action == 0)
				try{
					String query = ("Update Animal Name= '"+ textField.getText()+"' ,Type= '"+ textField_1.getText()+"' , Gender = '"+ textField_2 +"' , Breed ='"+ textField_3.getText()+"', OwnerID ='"+ textField_5.getText()+"'" );
					PreparedStatement ps = (PreparedStatement) con.prepareStatement(query);
					ps.execute();
		...
		frmEditAnimal.getContentPane().add(btnEdit);
